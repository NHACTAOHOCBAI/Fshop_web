    ...
    <div className={`flex gap-3 ${depth > 0 ? "ml-6" : ""} py-3`}>
      ...
      <div className="grow min-w-0">
        ...
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          {(isOwner || canDeleteComment) && !isEditing && (
        ...
        {isEditing ? (
          <div className="mt-1 space-y-2 pr-2">
            ...
            <div className="flex items-center gap-1.5 justify-end">
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-7 px-2 text-xs border border-slate-200 rounded-lg text-slate-600 hover:text-slate-900"
              ...
              <Button
                type="button"
                size="sm"
                className="h-7 px-3 text-xs rounded-lg bg-primary hover:bg-primary/95 text-white"
                onClick={onSaveEdit}
          ...
          <>
            {/* Comment Text */}
            <p className="mb-2 text-sm text-slate-700 wrap-break-word">
              {comment.content}
            </p>
