...
const ClientLayout = () => {
  ...
  const breadcrumbDepartment =
    currentDepartment === "men" ||
    currentDepartment === "women" ||
  ...
  const quickActionClass =
    "rounded-md p-2 transition-colors hover:bg-slate-100 hover:text-primary";
          ...
          <div className="flex items-center gap-2 text-slate-500">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="relative rounded-md p-2 transition-colors hover:bg-slate-100 hover:text-primary"
                >
            ...
            <button
              onClick={() => router("/my-account/wishlists")}
              type="button"
            ...
            <button
              onClick={() => router("/my-account/profile")}
              type="button"
              className={quickActionClass}
            >
      ...
      <footer className="mt-12 bg-primary/35">
        <div className="mx-auto grid w-full max-w-6xl gap-6 px-4 py-6 text-sm text-slate-700 md:grid-cols-3 md:px-8">
          <div>
            ...
            <p className="mt-2">
              Nền tảng bán hàng thời trang online với trải nghiệm nhanh và ổn
              định.
            </p>
          </div>
          <div>
            ...
            <p className="mt-2">
              Cập nhật xu hướng và bộ sưu tập mới mỗi tuần.
            </p>
          </div>
          <div>
            <p className="font-semibold text-slate-900">Liên hệ</p>
            <p className="mt-2">
              Ktx Khu B ĐHQG - Cổng Sau Ktx Khu B ĐHQG - Đường Tiêu Biểu Số 3 -
              Phường Linh Trung, Đông Hòa, Dĩ An, Bình Dương, Vietnam
            </p>
          </div>
        </div>
      </footer>
